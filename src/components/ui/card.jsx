...
export default function Card({name, image, id}) {
  ...
  return (
    <Link onClick={()=>{setNavigationCompleted(false)}} href={`/country/${id}`} className='w-[300px] relative h-[230px] relative cursor-pointer bg-grey transition-[.7s] transform lg:hover:scale-105 rounded-r10 p-[10px] lg:w-[200px] lg:h-[150px]'>
